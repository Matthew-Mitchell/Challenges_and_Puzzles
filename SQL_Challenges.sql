...
SELECT person_id FROM person_demos_final JOIN url_final_new USING(person_id) WHERE NOT url_final_new.domain_name='vw.com' ORDER BY RANDOM() LIMIT 100;
...
\\Tmp table; person_id, 1st visit to vw.com
